...
$flg = true;
echo '<div id="popular"><a href="login-list.php?sql=6"><img src="./img/人気.jpg" width="580px" height="325px"></a><div>';//人気の商品
if($sql){
...
$flg = true;
echo '<div id="campaign"><a href="login-list.php?sql=5"><img src="./img/CP.jpg" width="580px" height="325px"></a><div>';//キャンペーン商品
if($sql){
